...
with col1:
    metric_card("🚀 Literacy Rate", f"{avg_literacy:.1f}%")
with col2:
    metric_card("📚 Primary", f"{primary_avg:.1f}%", f"{(primary_avg - avg_literacy):.1f}%")
with col3:
    metric_card("🎓 Secondary", f"{secondary_avg:.1f}%", f"{(secondary_avg - primary_avg):.1f}%")
with col4:
    metric_card("🏛️ Higher Sec", f"{higher_sec_avg:.1f}%", f"{(higher_sec_avg - secondary_avg):.1f}%")
with col5:
    metric_card("🎓 Graduation", f"{grad_avg:.1f}%", f"{(grad_avg - higher_sec_avg):.1f}%")
